...
Picture a tree growing the wrong way. Roots above. Branches growing downward. A sacred fig inverted, as if you were standing on the sky looking down at a world that grows toward you. The strange image is given as imperishable, then in the same breath undermined: its real form is not seen, neither end nor beginning nor foundation. It looks rooted to those caught in the leaves. From inside the canopy, the canopy is the world.

This is your life on a normal day. You are inside the leaves. The rustle around you — your career, your relationships, the project that ended hollow, the one underway — feels like the floor. You stand on it, plan from it, defend it against threats. You experience it as solid because you experience it from within. The instruction is to do something difficult: look up. The root is in a different direction.

Then comes the instrument. With the weapon of non-attachment — call it the axe, in plain English — cut firmly. Non-attachment is not coldness. It is the freedom from being owned by what you have or what you fear to lose. Take the axe and cut the tree down. Walk in the direction the felling opens. You are not being asked to abandon your life. You are being asked to loosen its grip on you so you can see which way it is pointed.
...
Career is on the inventory. Status is on the inventory. Accomplishment is on the inventory. These are branches — sometimes magnificent ones — and the subtle warning is that branches do not finally hold.

Career is the most defensible candidate. It gives back so much that is real: structure, purpose, competence, an answer to *what do you do.* When the work aligns with your gifts, it feels like the floor. It is not. It will end — by retirement, by industry collapse, by the slow private discovery that the work no longer means what it used to — and whoever made it the root is, on that day, unmoored.

Status hides better. The frequent checking, the disproportionate hit when a metric falters, the restlessness that follows a slight. Accomplishment flatters: the shelf of finished projects, the company built, the children raised. What accumulates also depletes. None of these is bad. Some are very good. The work is to know which is which, and to hold each as branch, not as ground.
...
[Continue to Chapter 16 — The Divine and the Corrupt](16_divine_and_demonic.md)
